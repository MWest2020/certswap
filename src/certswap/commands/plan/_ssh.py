...
def plan_ssh(
    ...
    owner: Annotated[str | None, typer.Option("--owner", help="chown owner on remote")] = None,
    group: Annotated[str | None, typer.Option("--group", help="chown group on remote")] = None,
